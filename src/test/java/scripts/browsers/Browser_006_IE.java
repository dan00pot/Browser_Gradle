...
public class Browser_006_IE {
	
/*#################################################################################
 * Browser_006_IE	Server Connections - LDAP Configuration - add new Directory
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browser_006_IE");

	@Before
	public void beforetestBrowser_006_IE() throws Exception {
		logger.info("beforetest Browser_006_IE starting...\n");
		webDriver = driverMgnt.createIEDriver();
		logger.info("beforetest Browser_006_IE completed...\n");
	}

	@Test
	public void AADS_Browsers_006() throws Exception {
		try {
			logger.info("AADS_Browsers_006_IE- starting...\n");
			// login AADS web page
			...
			logger.info("AADS_Browsers_006_IE - Passed...\n");
			assertTrue(true);

		} catch (Exception exception) {
			AADSWebDriver.logoutAADSMainPage(webDriver);
			logger.error("AADS_Browsers_006_IE - Failed with Exception:"
					+ exception + "...\n");
			fail("AADS_Browsers_006_IE - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("AADS_Browsers_006_IE - completed...\n");
	}
