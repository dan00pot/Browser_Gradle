...
public class Browser_007_IE {
	
/*#################################################################################
* Browser_007_IE	Server Connections - LDAP Configuration - edit Directory
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browser_007_IE");

	@Before
	public void beforetestBrowser_007_IE() throws Exception {
		logger.info("beforetest Browser_007_IE starting...\n");
		webDriver = driverMgnt.createIEDriver();
		logger.info("beforetest Browser_007_IE completed...\n");
	}
	...
	public void AADS_Browsers_007() throws Exception {
		...
		try {
			logger.info("AADS_Browsers_007_IE- starting...\n");
			// login AADS web page
			...
			logger.info("AADS_Browsers_007_IE - Passed...\n");
			assertTrue(true);

		} catch (Exception exception) {
			logger.error("AADS_Browsers_007_IE- Failed with Exception:"	+ exception + "...\n");
			fail("AADS_Browsers_007_IE - Failed - Exception occurs: "+ exception.toString());
		}
		logger.info("AADS_Browsers_007_IE - completed...\n");
	}
