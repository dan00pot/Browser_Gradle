...
public class Browser_013_IE {
	
/*#################################################################################
 * Browser_013_IE	Logs Management - Collect logs
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("AADS_Browsers_013_IE");

	@Before
	public void beforetestAADS_Browsers_013_IE() throws Exception {
		logger.info("beforetest AADS_Browsers_013_IE starting...\n");
		webDriver = driverMgnt.createIEDriver();
		logger.info("beforetest AADS_Browsers_013_IE completed...\n");
	}
	...
	public void AADS_Browsers_013() throws Exception {
		...
		try {
			logger.info("AADS_Browsers_013_IE- starting...\n");
			// login AADS web page
			...
			logger.info("AADS_Browsers_013_IE - completed...\n");
			assertTrue(true);
		} catch (Exception exception) {
			logger.error("AADS_Browsers_013_IE - Failed with Exception:"
					+ exception + "...\n");
			fail("AADS_Browsers_013_IE - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("AADS_Browsers_013_IE - completed...\n");
	}
