...
public class Browser_015_IE {
	
/*#################################################################################
 * Browser_015_IE	Dynamic Configuration Tab - Configuration - Retrieve setting
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browsers_015_IE");
	String configurationName = "Browsers_IE_015";

	@Before
	public void beforetestAADS_Browsers_001_IE() throws Exception {
		logger.info("beforetest Browsers_015_IE starting...\n");
		webDriver = driverMgnt.createIEDriver();
		webDriver.manage().window().maximize();
		logger.info("beforetest Browsers_015_IE completed...\n");
	}

	@Test
	public void AADS_Browsers_015() throws Exception {
		logger.info("Browsers_015_IE - Starting\n");
		try {
			// Login AADS
			...
			logger.error("Browsers_015_IE - Failed with Exception:" + exception
					+ "...\n");
			fail("Browsers_015_IE - Failed - Exception occurs: "
					+ exception.toString());
		}
		
		logger.info("Browsers_015_IE - test completed\n");
	}
