...
public class Browser_020_IE {
	
/*#################################################################################
 * Browser_020_IE	Web Deployment Tab - Edit appcast item
 ...
 *################################################################################# */
	...
	@Test
	public void Browsers_020_IE() throws Exception {
		logger.info("Browsers_020_IE - Starting\n");
		try {
			...
			logger.error("Browsers_020_IE - Failed with Exception:" + exception
					+ "...\n");
			fail("Browsers_020_IE - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("Browsers_020_IE - completed...\n");
	}
