...
public class Browsers_Chrome_002 {
	
/*##################################################################################
 * Browsers_Chrome_002	Login Admin UI using incorrect user and password
...
#####################################################################################*/
	...
	final static Logger logger = LogManager.getLogger("Browsers_Chrome_002");

	@Before
	public void beforetestBrowsers_Chrome_002() throws Exception {
		logger.info("beforetest Browsers_Chrome_002 starting...\n");
		webDriver = driverMgnt.createChromeDriver();
		logger.info("beforetest Browsers_Chrome_002 completed...\n");
	}

	@Test
	public void AADS_Browsers_002() throws Exception {
		logger.info("AADS_Browsers_002_Chrome- starting...\n");
		...
		try {
			...
			assertTrue(n);
			logger.info("Browsers_Chrome_002 - Passed\n");

			assertTrue(true);
		} catch (Exception exception) {
			AADSWebDriver.logoutAADSMainPage(webDriver);
			logger.error("AADS_Browsers_002_Chrome - Failed with Exception:"
					+ exception + "...\n");
			fail("AADS_Browsers_002_Chrome - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("AADS_Browsers_002_Chrome - completed...\n");
	}
