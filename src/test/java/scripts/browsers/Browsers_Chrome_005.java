...
public class Browsers_Chrome_005 {
	
/*#################################################################################
 * Browsers_Chrome_005	Client Administration Tab
 ...
 *################################################################################ */
	...
	final static Logger logger = LogManager.getLogger("Browsers_Chrome_005");

	@Before
	public void beforetestBrowsers_Chrome_005() throws Exception {
		logger.info("beforetest Browsers_Chrome_005 starting...\n");
		webDriver = driverMgnt.createChromeDriver();
		logger.info("beforetest Browsers_Chrome_005 completed...\n");
	}

	@Test
	public void AADS_Browsers_005() throws Exception {
		logger.info("AADS_Browsers_005_Chrome- starting...\n");
		try {
			// login AADS web page
			...
			logger.info("Browsers_Chrome_005 passed...\n");
			assertTrue(true);
		} catch (Exception exception) {
			AADSWebDriver.logoutAADSMainPage(webDriver);
			logger.error("AADS_Browsers_005_Chrome - Failed with Exception:"
					+ exception + "...\n");
			fail("AADS_Browsers_005_Chrome - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("AADS_Browsers_005_Chrome - completed...\n");
	}
