...
public class Browsers_Chrome_007 {
	
/*#################################################################################
* Browsers_Chrome_007	Server Connections - LDAP Configuration - edit Directory
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browsers_Chrome_007");

	@Before
	public void beforetestBrowsers_Chrome_007() throws Exception {
		logger.info("beforetest Browsers_Chrome_007 starting...\n");
		webDriver = driverMgnt.createChromeDriver();
		logger.info("beforetest Browsers_Chrome_007 completed...\n");
	}
	...
	public void AADS_Browsers_007() throws Exception {
		...
		try {
			logger.info("Browsers_Chrome_007- starting...\n");
			// login AADS web page
			...
			logger.info("Browsers_Chrome_007 - Passed...\n");
			assertTrue(true);

		} catch (Exception exception) {
			AADSWebDriver.logoutAADSMainPage(webDriver);
			logger.error("AADS_Browsers_007_Chrome - Failed with Exception:"
					+ exception + "...\n");
			fail("AADS_Browsers_007_Chrome - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("AADS_Browsers_007_Chrome - completed...\n");
	}
