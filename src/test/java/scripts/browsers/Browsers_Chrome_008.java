...
public class Browsers_Chrome_008 {
	
/*#################################################################################
 * Browsers_Chrome_008	Server Connections - LDAP Configuration - delete Directory
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browsers_Chrome_008");

	@Before
	public void beforetestBrowsers_Chrome_008() throws Exception {
		logger.info("beforetest Browsers_Chrome_008 starting...\n");
		webDriver = driverMgnt.createChromeDriver();
		logger.info("beforetest Browsers_Chrome_008 completed...\n");
	}
	...
	public void AADS_Browsers_008() throws Exception {
		...
		try {
			logger.info("Browsers_Chrome_008- starting...\n");
			// login AADS web page
			...
			logger.info("Browsers_Chrome_008 - Passed...\n");
			assertTrue(true);

		} catch (Exception exception) {
			AADSWebDriver.logoutAADSMainPage(webDriver);
			logger.error("AADS_Browsers_008_Chrome - Failed with Exception:"
					+ exception + "...\n");
			fail("AADS_Browsers_008_Chrome - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("AADS_Browsers_008_Chrome - completed...\n");
	}
