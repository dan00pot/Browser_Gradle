...
public class Browsers_Chrome_009 {
	
/*#################################################################################
 * Browsers_Chrome_009	Server Connections - CORS Configuration
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browsers_Chrome_009");

	@Before
	public void beforetestBrowsers_Chrome_009() throws Exception {
		logger.info("beforetest Browsers_Chrome_009 starting...\n");
		webDriver = driverMgnt.createChromeDriver();
		logger.info("beforetest Browsers_Chrome_009 completed...\n");
	}
	...
	public void AADS_Browsers_009() throws Exception {
		...
		try {
			logger.info("Browsers_Chrome_009- starting...\n");
			// login AADS web page
			...
			logger.info("Browsers_Chrome_009 - Passed...\n");
			assertTrue(true);

			logger.info("AADS_Browsers_009_Chrome - Passed...\n");
		} catch (Exception exception) {
			logger.error("AADS_Browsers_009_Chrome - Failed with Exception:"
					+ exception + "...\n");
			fail("AADS_Browsers_009_Chrome - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("AADS_Browsers_009_Chrome - completed...\n");
	}
