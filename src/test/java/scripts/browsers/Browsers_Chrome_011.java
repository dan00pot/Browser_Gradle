...
public class Browsers_Chrome_011 {
	
/*#################################################################################
 * Browsers_Chrome_011	Cluster Configuration
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browsers_Chrome_011");

	@Before
	public void beforetestBrowsers_Chrome_011() throws Exception {
		logger.info("beforetest Browsers_Chrome_011 starting...\n");
		webDriver = driverMgnt.createChromeDriver();
		logger.info("beforetest Browsers_Chrome_011 completed...\n");
	}

	@Test
	public void AADS_Browsers_011() throws Exception {
		try {
			logger.info("Browsers_Chrome_011- starting...\n");
			// login AADS web page
			...
			logger.info("Browsers_Chrome_011 - Passed...\n");
			assertTrue(true);
		} catch (Exception exception) {
			AADSWebDriver.logoutAADSMainPage(webDriver);
			logger.error("AADS_Browsers_011_Chrome - Failed with Exception:"
					+ exception + "...\n");
			fail("AADS_Browsers_011_Chrome - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("AADS_Browsers_011_Chrome - completed...\n");
	}
