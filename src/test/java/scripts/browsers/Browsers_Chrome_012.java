...
public class Browsers_Chrome_012 {
	
/*#################################################################################
 * Browsers_Chrome_012	Logs Management - Change log level
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browsers_Chrome_012");

	@Before
	public void beforetestBrowsers_Chrome_012() throws Exception {
		logger.info("beforetest Browsers_Chrome_012 starting...\n");
		webDriver = driverMgnt.createChromeDriver();
		logger.info("beforetest Browsers_Chrome_012 completed...\n");
	}
	...
	public void AADS_Browsers_012() throws Exception {
		...
		try {
			logger.info("Browsers_Chrome_012- starting...\n");
			// login AADS web page
			...
			logger.info("Browsers_Chrome_012- completed...\n");
			assertTrue(result);
		} catch (Exception exception) {
			AADSWebDriver.logoutAADSMainPage(webDriver);
			logger.error("AADS_Browsers_012_Chrome - Failed with Exception:"+ exception + "...\n");
			fail("AADS_Browsers_012_Chrome - Failed - Exception occurs: "+ exception.toString());
		}
		logger.info("AADS_Browsers_012_Chrome - completed...\n");
	}
