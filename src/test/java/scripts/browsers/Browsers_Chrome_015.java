...
public class Browsers_Chrome_015 {
	
/*#################################################################################
 * Browsers_Chrome_015	Dynamic Configuration Tab - Configuration - Retrieve setting
 ...
 *################################################################################# */
	...
	String configurationName = "Browsers_Chrome_015";

	@Before
	public void beforetestBrowsers_Chrome_015() throws Exception {
		logger.info("beforetest Browsers_Chrome_015 starting...\n");
		webDriver = driverMgnt.createChromeDriver();
		logger.info("beforetest Browsers_Chrome_015 completed...\n");
	}

	@Test
	public void AADS_Browsers_015() throws Exception {
		logger.info("Browsers_Chrome_015 - Starting\n");
		try {
			// Login AADS
			...
			logger.error("Browsers_Chrome_015 - Failed with Exception:" + exception
					+ "...\n");
			fail("Browsers_Chrome_015 - Failed - Exception occurs: "
					+ exception.toString());
		}
		
		logger.info("Browsers_Chrome_015 - test completed\n");
	}
