...
public class Browsers_Chrome_016 {
	
/*#################################################################################
 * Browsers_Chrome_016	Dynamic Configuration Tab - DNS Mapping
 ...
 *################################################################################# */
	...
	@Test
	public void Browsers_016_Chrome() throws Exception {
		logger.info("Browsers_016_Chrome - Starting\n");
		try {
			...
			logger.error("Browsers_016_Chrome - Failed with Exception:"
					+ exception + "...\n");
			fail("Browsers_016_Chrome - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("Browsers_016_Chrome - test completed\n");
	}
