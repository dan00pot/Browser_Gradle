...
public class Browsers_Chrome_018 {
	
/*#################################################################################
 * Browsers_Chrome_018	Dynamic Configuration Tab - View Published Setting
 ...
 *################################################################################# */
	...
	String configurationName = "Browsers_Chrome_018";
	final static Logger logger = LogManager.getLogger("Browsers_Chrome_018");

	@Before
	public void beforetestBrowsers_Chrome_018() throws Exception {
		logger.info("beforetest Browsers_Chrome_018 starting...\n");
		webDriver = driverMgnt.createChromeDriver();
		logger.info("beforetest Browsers_Chrome_018 completed...\n");
	}

	@Test
	public void Browsers_Chrome_018() throws Exception {
		logger.info("Browsers_Chrome_018 - Starting\n");
		try {
			// Login AADS
			...
			logger.error("Browsers_Chrome_018 - Failed with Exception:" + exception
					+ "...\n");
			fail("Browsers_Chrome_018 - Failed - Exception occurs: "
					+ exception.toString());
		} 
		logger.info("Browsers_Chrome_018 - test completed\n");
	}
