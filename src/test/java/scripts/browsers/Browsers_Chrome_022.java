...
public class Browsers_Chrome_022 {
	
/*#################################################################################
 * Browsers_Chrome_022	Pictures Tab
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browsers_Chrome_022");

	@Before
	public void beforetestBrowsers_Chrome_022() throws Exception {
		logger.info("beforetest Browsers_Chrome_022 starting...\n");
		webDriver = driverMgnt.createChromeDriver();
		logger.info("beforetest Browsers_Chrome_022 completed...\n");
	}

	@Test
	public void Browsers_022_Chrome() throws Exception {
		logger.info("Browsers_022_Chrome - Starting\n");
		try {
			// Login AADS
			...
			logger.error("Browsers_022_Chrome - Failed with Exception:"
					+ exception + "...\n");
			fail("Browsers_022_Chrome - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("Browsers_022_Chrome - test completed\n");
	}
