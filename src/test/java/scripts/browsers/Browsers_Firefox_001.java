...
public class Browsers_Firefox_001 {
	
/*#############################################################################
 * Browsers_Firefox_001: Login and logout adminUi using correct user and password
...
3. AdminUI back to login page "
 ...
 ##############################################################################*/
	...
	final static Logger logger = LogManager.getLogger("Browsers_001_Firefox");

	@Before
	public void beforetestBrowsers_001_Firefox() throws Exception {
		logger.info("beforetest Browsers_001_Firefox starting...\n");
		webDriver = driverMgnt.createFFDriver();
		logger.info("beforetest Browsers_001_Firefox completed...\n");
	}

	@Test
	public void AADS_Browsers_001() throws Exception {
		logger.info("Browsers_001_Firefox - starting...\n");
		...
		try {
			...
			logger.error("Browsers_001_Firefox - Failed with Exception:"
					+ exception + "...\n");
			fail("Browsers_001_Firefox - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("Browsers_001_Firefox - completed...\n");
	}
