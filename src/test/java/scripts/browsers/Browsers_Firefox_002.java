...
public class Browsers_Firefox_002 {
	
/*##################################################################################
 * Browsers_Firefox_002	Login Admin UI using incorrect user and password
...
#####################################################################################*/
	...
	final static Logger logger = LogManager.getLogger("Browsers_Firefox_002");

	@Before
	public void beforetestAADS_Browsers_001_IE() throws Exception {
		logger.info("beforetest Browsers_Firefox_002 starting...\n");
		webDriver = driverMgnt.createFFDriver();
		logger.info("beforetest Browsers_Firefox_002 completed...\n");
	}

	@Test
	public void AADS_Browsers_002() throws Exception {
		logger.info("AADS_Browsers_002_Firefox- starting...\n");
		...
		try {
			...
			logger.error("AADS_Browsers_002_Firefox - Failed with Exception:"
					+ exception + "...\n");
			fail("AADS_Browsers_002_Firefox - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("AADS_Browsers_002_Firefox - completed...\n");
	}
