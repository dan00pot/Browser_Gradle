...
public class Browsers_Firefox_006 {
	
/*#################################################################################
 * Browsers_Firefox_006	Server Connections - LDAP Configuration - add new Directory
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browsers_Firefox_006");

	@Before
	public void beforetestBrowsers_Firefox_006() throws Exception {
		logger.info("beforetest Browsers_Firefox_006 starting...\n");
		webDriver = driverMgnt.createFFDriver();
		logger.info("beforetest Browsers_Firefox_006 completed...\n");
	}

	@Test
	public void AADS_Browsers_006() throws Exception {
		try {
			logger.info("Browsers_Firefox_006- starting...\n");
			// login AADS web page
			...
			// Add new directory
			AADSWebDriver.ldapConfigAddNewDirectory(webDriver, "IE");
			logger.info("Browsers_Firefox_006 - Passed...\n");
			assertTrue(true);

		} catch (Exception exception) {
			AADSWebDriver.logoutAADSMainPage(webDriver);
			logger.error("AADS_Browsers_006_Firefox - Failed with Exception:"
					+ exception + "...\n");
			fail("AADS_Browsers_006_Firefox - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("AADS_Browsers_006_Firefox - completed...\n");
	}
