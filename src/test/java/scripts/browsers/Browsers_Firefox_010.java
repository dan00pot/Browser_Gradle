...
public class Browsers_Firefox_010 {
	
/*#################################################################################
 * Browsers_Firefox_010	Server Connections - Trusted Hosts
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browsers_Firefox_010");

	@Before
	public void beforetestBrowsers_Firefox_010() throws Exception {
		logger.info("beforetest Browsers_Firefox_010 starting...\n");
		webDriver = driverMgnt.createFFDriver();
		logger.info("beforetest Browsers_Firefox_010 completed...\n");
	}

	@Test
	public void Browsers_010_Firefox() throws Exception {

		try {
			logger.info("Browsers_Firefox_010 - starting...\n");
			// login AADS web page
			...
			// Deleted directory
			logger.info("Browsers_Firefox_010 - Passed...\n");
			assertTrue(true);
		} catch (Exception exception) {
			logger.error("Browsers_Firefox_010 - Failed with Exception:"
					+ exception + "...\n");
			fail("Browsers_Firefox_010 - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("Browsers_Firefox_010 - completed...\n");
	}
