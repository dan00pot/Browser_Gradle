...
public class Browsers_Firefox_014 {
	
/*#################################################################################
 * Browsers_Firefox_014	Dynamic Configuration Tab - Configuration - Set and Publish setting
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browsers_Firefox_014");
	String configurationName = "Browsers_014_Firefox";

	@Before
	public void beforetestBrowsers_Firefox_014() throws Exception {
		logger.info("beforetest Browsers_Firefox_014 starting...\n");
		webDriver = driverMgnt.createFFDriver();
		logger.info("beforetest Browsers_Firefox_014 completed...\n");
	}

	@Test
	public void Browsers_014_Firefox() throws Exception {
		logger.info("Browsers_014_Firefox - Starting\n");
		try {
			// Login AADS
...
//			 aadsData.AADS_USER_1_NAME);
			...
			logger.error("Browsers_014_Firefox - Failed with Exception:"
					+ exception + "...\n");
			fail("Browsers_014_Firefox - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("Browsers_014_Firefox - test completed\n");
	}
