...
public class Browsers_Firefox_017 {
	
/*#################################################################################
 * Browsers_Firefox_017	Dynamic Configuration Tab - Default
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browsers_Firefox_017");

	@Before
	public void beforetestBrowsers_Firefox_017() throws Exception {
		logger.info("beforetest Browsers_Firefox_017 starting...\n");
		webDriver = driverMgnt.createFFDriver();
		logger.info("beforetest Browsers_Firefox_017 completed...\n");
	}

	@Test
	public void Browsers_017_Firefox() throws Exception {
		logger.info("Browsers_Firefox_017 - Starting\n");
		try {
			// Login AADS
			...
			logger.error("Browsers_Firefox_017 - Failed with Exception:"
					+ exception + "...\n");
			fail("Browsers_Firefox_017 - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("Browsers_Firefox_017 - test completed\n");
	}
