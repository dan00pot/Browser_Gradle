...
public class Browsers_Firefox_020 {
	
/*#################################################################################
 * Browsers_Firefox_020	Web Deployment Tab - Edit appcast item
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browsers_Firefox_020");

	@Before
	public void beforetestBrowsers_Firefox_020() throws Exception {
		logger.info("beforetest Browsers_Firefox_020 starting...\n");
		webDriver = driverMgnt.createFFDriver();
		logger.info("beforetest Browsers_Firefox_020 completed...\n");
	}

	@Test
	public void Browsers_020_Firefox() throws Exception {
		logger.info("Browsers_020_Firefox - Starting\n");
		try {
			...
			logger.info("Browsers_020_IE - Passed\n");
			assertTrue(true);
		} catch (Exception exception) {
			logger.error("Browsers_020_Firefox - Failed with Exception:"
					+ exception + "...\n");
			fail("Browsers_020_Firefox - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("Browsers_020_Firefox - completed...\n");
	}
