...
public class Browsers_Firefox_021 {
	
/*#################################################################################
 * Browsers_Firefox_021	Web Deployment Tab - Remove appcast item
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browsers_Firefox_021");

	@Before
	public void beforetestBrowsers_Firefox_021() throws Exception {
		logger.info("beforetest Browsers_Firefox_021 starting...\n");
		webDriver = driverMgnt.createFFDriver();
		logger.info("beforetest Browsers_Firefox_021 completed...\n");
	}

	@Test
	public void Browsers_021_Firefox() throws Exception {
		logger.info("Browsers_021_Firefox - Starting\n");
		try {
			...
			logger.error("Browsers_021_Firefox - Failed with Exception:"
					+ exception + "...\n");
			fail("Browsers_021_Firefox - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("Browsers_021_Firefox - completed...\n");
	}
