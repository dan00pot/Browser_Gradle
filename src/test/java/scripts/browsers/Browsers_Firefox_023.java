...
public class Browsers_Firefox_023 {
	
/*#################################################################################
 * Browsers_Firefox_023	Contact Integrity Tab
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browsers_Firefox_023");

	@Before
	public void beforetestBrowsers_Firefox_023() throws Exception {
		logger.info("beforetest Browsers_Firefox_023 starting...\n");
		webDriver = driverMgnt.createFFDriver();
		logger.info("beforetest Browsers_Firefox_023 completed...\n");
	}

	@Test
	public void Browsers_023_Firefox() throws Exception {
		logger.info("Browsers_023_Firefox - Starting\n");
		try {
			// Login AADS
			...
			AADSWebDriver.contactIntegrityVerifyAnnoncement(webDriver, "1",	"Firefox");
			assertTrue(true);
		} catch (Exception exception) {
			logger.error("Browsers_023_Firefox - Failed with Exception:"
					+ exception + "...\n");
			fail("Browsers_023_Firefox - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("Browsers_023_Firefox - test completed\n");
	}
