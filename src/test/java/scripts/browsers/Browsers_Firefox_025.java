...
public class Browsers_Firefox_025 {
	
/*#################################################################################
 * Browsers_Firefox_025	Open in another new
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browsers_Firefox_025");

	@Before
	public void beforetestBrowsers_Firefox_025() throws Exception {
		logger.info("beforetest Browsers_Firefox_025 starting...\n");
		webDriver = driverMgnt.createFFDriver();
		logger.info("beforetest Browsers_Firefox_025 completed...\n");
	}
