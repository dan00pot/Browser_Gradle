...
public class Browsers_Firefox_027 {
	
/*#################################################################################
 * Browsers_Firefox_027	About button
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browsers_Firefox_027");
	...
	@Before
	public void beforetestBrowsers_Firefox_027() throws Exception {
		logger.info("beforetest Browsers_Firefox_027 starting...\n");
		webDriver = driverMgnt.createFFDriver();
		logger.info("beforetest Browsers_Firefox_027 completed...\n");
	}

	@Test
	public void Browsers_027_Firefox() throws Exception {
		logger.info("Browsers_027_Firefox - Starting\n");
		try {
			// Login AADS
			...
			logger.error("Browsers_027_Firefox - Failed with Exception:"
					+ exception + "...\n");
			fail("Browsers_027_Firefox - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("Browsers_027_Firefox - test completed\n");
	}
