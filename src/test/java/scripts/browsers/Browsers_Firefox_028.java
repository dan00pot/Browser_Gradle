...
public class Browsers_Firefox_028 {
	
/*#################################################################################
 * Browsers_Firefox_028	Discard setting
 ...
 *################################################################################# */
	...
	final static Logger logger = LogManager.getLogger("Browsers_Firefox_028");
	String warning = "";

	@Before
	public void beforetestBrowsers_Firefox_028() throws Exception {
		logger.info("beforetest Browsers_Firefox_028 starting...\n");
		webDriver = driverMgnt.createFFDriver();
		logger.info("beforetest Browsers_Firefox_028 completed...\n");
	}

	@Test
	public void Browsers_028_Firefox() throws Exception {
		logger.info("Browsers_028_Firefox - Starting\n");
		try {
			// Login AADS
...
//			AADSWebDriver.navigateToFeaturesPage(webDriver, "Configuration");
			...
			logger.error("Browsers_028_Firefox - Failed with Exception:"
					+ exception + "...\n");
			fail("Browsers_028_Firefox - Failed - Exception occurs: "
					+ exception.toString());
		}
		logger.info("Browsers_028_Firefox - test completed\n");
	}
