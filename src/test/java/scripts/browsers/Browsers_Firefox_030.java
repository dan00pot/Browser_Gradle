...
public class Browsers_Firefox_030 {
	...
	final static Logger logger = LogManager.getLogger("Browsers_Firefox_030");

	@Before
	public void beforetestBrowsers_Firefox_030() throws Exception {
		logger.info("beforetest Browsers_Firefox_030 starting...\n");
		webDriver = driverMgnt.createFFDriver();
		logger.info("beforetest Browsers_Firefox_030 completed...\n");
	}

	@Test
	public void AADS_Browsers_030() throws Exception {
		try {
			logger.info("Browsers_Firefox_030- starting...\n");
			// login AADS web page
			...
			logger.info("Browsers_Firefox_030- Passed...\n");
		} catch (Exception exception) {
			AADSWebDriver.logoutAADSMainPage(webDriver);
			logger.error("AADS_Browsers_030_Firefox - Failed with Exception:"
					+ exception + "...\n");
			fail("AADS_Browsers_030_Firefox - Failed - Exception occurs: "
					+ exception.toString());
		}
